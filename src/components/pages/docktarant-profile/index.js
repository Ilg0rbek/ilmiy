              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      <h4>Abdumalikov I</h4>
                      <p class="text-secondary mb-1">Doktarantura talabasi</p>
                      <p class="text-muted font-size-sm">
                        Oltinko'l tumani , Andijon viloyati
                      </p>
                      {/* <button class="btn btn-primary">Follow</button>
                      <button class="btn btn-outline-primary ms-1">Message</button> */}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Qo'shimcha nomer</h6>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info "  >Tahrirlash</a>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3">
                        <i class="material-icons text-info pr-3">assignment</i>
                        Kerakli hujjatlar
                      </h6>
