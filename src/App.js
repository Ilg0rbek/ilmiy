...
function App() {
  return (
    <Routes>
      ...
      <Route
        exact
        path="/faculties/:academic_year_id"
        element={
          <Layout>
            <Faculty />
          </Layout>
      ...
      <Route
        exact
        path="/themes/:academic_year_id/:faculty_id/:kafedra_id"
        element={
          <Layout>
            <Themes />
          </Layout>
      ...
      />
      <Route
        path={`/stipendiants/students`}
        element={
          <Layout>
            <PresidentStipendiant />
          </Layout>
        }
      />
      <Route
        path={`/stipendiants/students/detail/:id`}
        element={
          <Layout>
            <StipendiantDeatail />
          </Layout>
      ...
      />
      <Route
        path={`/tavarlar kimyosi va halq tabobati`}
        element={
          <Layout>
            <TavarlarKimyosi />
          </Layout>
      ...
      />
      <Route
        path={`/Bialogiya fanlari boyicha`}
        element={
          <Layout>
            <BialogiyaFanlarBoyicha />
          </Layout>
        }
      />
      <Route
      ...
      <Route
        exact
        path="/cources/kafedra"
        element={
          <Layout>
            <FanTogarakKafedraUser />
          </Layout>
        }
      />
      <Route
        exact
        path="/cources/kafedra/detail/:id"
        element={
          <Layout>
            <FanTogarakDetailUser />
          </Layout>
        }
      />
