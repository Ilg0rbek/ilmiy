...
import FantogarakNameAdd from "./FanTogarakName.Add.modal";
...
const FanTogarak = () =>{
    ...
    return(
        ...
        <div className="addNewYear" onClick={showModal}>
          Yangi o'quv yili hamda fan to'garaklarni qo'shish <PlusOutlined />
        </div>
        <FanTogarrakAdd isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen}/>
        <FantogarakNameAdd yearId={yearId} isModalOpen2={isModalOpen2} setIsModalOpen2={setIsModalOpen2}/>
